...
public class FourPeaksTest_Toy {
    /** The n value */
    private static final int[] N = IntStream.iterate(20, i -> i + 20).limit(6).toArray();
    /** The t value */
    ...
    public static void main(String[] args) {
        ...
        for (int num : N) {
            ...
            for (int iter : iters) {
                ...
                String final_result = "";
                final_result = "N," + num + ",rhc" + "," + iter + "," + Integer.toString(average_rhc) + "," + Double.toString(averagetime_rhc) + "," +
