    ...
    public static void main(String[] args) {
        ...
        for (int trainingIterations : iterations) {
			...
			//for (double cooling : coolings) {
                ...
                final_result = oaNames[0] + ",train," + trainingIterations + "," + coolings[q] + "," + temperatures[q] + "," + "training accuracy" + "," + df.format(correct*100 / (correct + incorrect))
                ...
                final_result = oaNames[0] + ",test," + trainingIterations + "," + coolings[q] + "," + temperatures[q] + "," + "testing accuracy" + "," + df.format(correct*100 / (correct + incorrect))
                        + "," + "training time" + "," + df.format(trainingTime) + "," + "training error" + "," + df.format(train_error) + "," + "testing time" +
                        "," + df.format(testingTime) + "," + "f1 score" + "," + df.format(2.0*tp/(2*tp + fn + fp));
                write_output_to_file("Optimization_Results", "phishing_results_sa.csv", final_result, true);
            }
