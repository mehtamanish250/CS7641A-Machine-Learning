...
public class TravelingSalesman_Toy {
    /** The n value */
    private static final int[] N = IntStream.iterate(10, i -> i + 10).limit(5).toArray();
    ...
    public static void main(String[] args) {
        ...
        int[] iters = {10, 100, 1000, 5000, 10000, 25000, 50000, 100000};
        //int[] iters = {10};
        int testRuns = 5;

        for (int num : N) {
            System.out.println("For N = " + num);
            ...
            for (int iter : iters) {
                ...
                for (int j = 0; j < testRuns; j++) {
                    ...
                    Distribution odd = new DiscretePermutationDistribution(num);
                    ...
                    int[] ranges = new int[num];
                    Arrays.fill(ranges, num);
                ...
                String final_result = "";
                final_result = "N," + num + ",rhc" + "," + iter + "," + Double.toString(average_rhc) + "," + Double.toString(averagetime_rhc) + "," +
