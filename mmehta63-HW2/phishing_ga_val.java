...
public class phishing_ga_val {
    ...
    // NNet Structure
    private static int inputLayer = 100, outputLayer = 1;
    ...
    public static void main(String[] args) {
        ...
        for (int trainingIterations : iterations) {
            ...
            for (int q = 0; q < population.length; q++) {
                ...
                double train_error = train(oa[0], networks[0], oaNames[0], trainingIterations); //trainer.train();
                end = System.nanoTime();
                ...
                final_result = oaNames[0] + ",train," + trainingIterations + "," + population[q] + "," + mate[q] + "," + mute[q] + "," + "training accuracy" + "," + df.format(correct*100 / (correct + incorrect))
                        + "," + "training time" + "," + df.format(trainingTime) + "," + "training error" + "," + df.format(train_error) + "," + "testing time" +
                ...
                final_result = oaNames[0] + ",test," + trainingIterations + "," + population[q] + "," + mate[q] + "," + mute[q] + "," + "testing accuracy" + "," + df.format(correct*100 / (correct + incorrect))
                        + "," + "training time" + "," + df.format(trainingTime) + "," + "training error" + "," + df.format(train_error) + "," + "testing time" +
                        "," + df.format(testingTime) + "," + "f1 score" + "," + df.format(2.0*tp/(2*tp + fn + fp));
                write_output_to_file("Optimization_Results", "phishing_results_ga.csv", final_result, true);
            }
    ...
    private static double train(OptimizationAlgorithm oa, BackPropagationNetwork network, String oaName, int iteration) {
